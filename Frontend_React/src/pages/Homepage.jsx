...
const categories = [
  { id: "cat-1", name: "Giảm đau", key: "pain_relief", slug: "pain-relief", icon: "fas fa-pills" },
  { id: "cat-2", name: "Vitamin", key: "vitamins", slug: "vitamins", icon: "fas fa-leaf" },
  { id: "cat-3", name: "Chăm sóc da", key: "skin_care", slug: "skin-care", icon: "fas fa-hand-sparkles" },
  { id: "cat-4", name: "Sức khỏe tim mạch", key: "heart_health", slug: "heart-health", icon: "fas fa-heartbeat" },
  { id: "cat-5", name: "Sức khỏe tâm thần", key: "mental_health", slug: "mental-health", icon: "fas fa-brain" },
  { id: "cat-6", name: "Hô hấp", key: "respiratory", slug: "respiratory", icon: "fas fa-lungs" },
];
...
const whyChoose = [
  {
    ...
    subtitle: "Nguồn gốc từ các nhà sản xuất được xác minh rõ ràng.",
  },
  {
    id: "why-2",
    icon: "fas fa-shipping-fast",
    title: "Giao Hàng Nhanh",
    subtitle: "Giao hàng toàn quốc trong 24-48 giờ.",
  },
  {
    id: "why-3",
    icon: "fas fa-user-md",
    title: "Dược Sĩ 24/7",
    subtitle: "Chuyên gia sẵn sàng hỗ trợ mọi lúc.",
  },
  {
    id: "why-4",
    icon: "fas fa-lock",
    title: "Thanh Toán An Toàn",
    subtitle: "Bảo vệ nhiều lớp, an tâm thanh toán.",
  },
];
...
const reviews = [
  ...
  },
  {
    id: "rev-3",
    name: "Huy Trần",
    comment: "Chat với dược sĩ rất hữu ích, kể cả lúc đêm khuya.",
      ...
      <HeroSection />
        ...
        <div className="section-header text-center">
          ...
          <p className="section-subtitle">
            Khám phá các sản phẩm sức khỏe đáng tin cậy được tuyển chọn cho bạn mỗi ngày.
          </p>
        </div>
        ...
        <div className="section-header text-center">
          ...
          <h2 className="fw-bold">Nhà thuốc trực tuyến tin cậy của bạn</h2>
          <p className="section-subtitle">
        ...
        <div className="weekly-banner">
            ...
            <div>
              ...
              <h3 className="mb-2">Tiết kiệm nhiều hơn cho sản phẩm thiết yếu</h3>
              <p className="section-subtitle mb-0">
                Lựa chọn được tuyển chọn cập nhật mỗi tuần với chất lượng chuẩn nhà thuốc.
              </p>
            </div>
          </div>
        ...
        <div className="section-header text-center">
          ...
          <p className="section-subtitle">
            Phản hồi thực tế từ những người tin tưởng chúng tôi với sức khỏe hằng ngày của họ.
          </p>
        </div>
  ...
  {featuredProducts.length === 0 ? (
    <div className="featured-card text-center">
      ...
      <p className="text-muted mb-4">
        Chúng tôi đang tuyển chọn các sản phẩm hàng đầu cho bạn. Trong lúc chờ đợi, hãy duyệt danh mục để tìm sản phẩm phù hợp.
      </p>
      <button className="btn btn-primary px-4" onClick={() => navigate("/products")}>Xem tất cả thuốc</button>
    </div>
  ) : (
